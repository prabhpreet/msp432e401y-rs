...
pub struct R(crate::R<DR2R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DR2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DR2R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DR2R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DR2R` writer"]
pub struct W(crate::W<DR2R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DR2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DR2R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DR2R_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
