...
pub struct R(crate::R<RCGCUSB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCGCUSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCGCUSB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCGCUSB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCGCUSB` writer"]
pub struct W(crate::W<RCGCUSB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCGCUSB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCGCUSB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCGCUSB_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SYSCTL_RCGCUSB_R0` reader - USB Module Run Mode Clock Gating Control"]
pub type SYSCTL_RCGCUSB_R0_R = crate::BitReader<bool>;
#[doc = "Field `SYSCTL_RCGCUSB_R0` writer - USB Module Run Mode Clock Gating Control"]
pub type SYSCTL_RCGCUSB_R0_W<'a> = crate::BitWriter<'a, u32, RCGCUSB_SPEC, bool, 0>;
impl R {
...
impl W {
    #[doc = "Bit 0 - USB Module Run Mode Clock Gating Control"]
    #[inline(always)]
    pub fn sysctl_rcgcusb_r0(&mut self) -> SYSCTL_RCGCUSB_R0_W {
