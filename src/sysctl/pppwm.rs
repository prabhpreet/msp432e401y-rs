...
pub struct R(crate::R<PPPWM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PPPWM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PPPWM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PPPWM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PPPWM` writer"]
pub struct W(crate::W<PPPWM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PPPWM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PPPWM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PPPWM_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SYSCTL_PPPWM_P0` reader - PWM Module 0 Present"]
pub type SYSCTL_PPPWM_P0_R = crate::BitReader<bool>;
#[doc = "Field `SYSCTL_PPPWM_P0` writer - PWM Module 0 Present"]
pub type SYSCTL_PPPWM_P0_W<'a> = crate::BitWriter<'a, u32, PPPWM_SPEC, bool, 0>;
impl R {
...
impl W {
    #[doc = "Bit 0 - PWM Module 0 Present"]
    #[inline(always)]
    pub fn sysctl_pppwm_p0(&mut self) -> SYSCTL_PPPWM_P0_W {
