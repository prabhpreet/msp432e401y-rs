...
pub struct R(crate::R<IF2MSK1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IF2MSK1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IF2MSK1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IF2MSK1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IF2MSK1` writer"]
pub struct W(crate::W<IF2MSK1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IF2MSK1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IF2MSK1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IF2MSK1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CAN_IF2MSK1_IDMSK` reader - Identifier Mask"]
pub type CAN_IF2MSK1_IDMSK_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CAN_IF2MSK1_IDMSK` writer - Identifier Mask"]
pub type CAN_IF2MSK1_IDMSK_W<'a> = crate::FieldWriter<'a, u32, IF2MSK1_SPEC, u16, u16, 16, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - Identifier Mask"]
    #[inline(always)]
    pub fn can_if2msk1_idmsk(&mut self) -> CAN_IF2MSK1_IDMSK_W {
...
#[doc = "CAN IF2 Mask 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [if2msk1](index.html) module"]
