...
pub type CAN_BRPE_BRPE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CAN_BRPE_BRPE` writer - Baud Rate Prescaler Extension"]
pub type CAN_BRPE_BRPE_W<'a> = crate::FieldWriter<'a, u32, BRPE_SPEC, u8, u8, 4, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - Baud Rate Prescaler Extension"]
    #[inline(always)]
    pub fn can_brpe_brpe(&mut self) -> CAN_BRPE_BRPE_W {
