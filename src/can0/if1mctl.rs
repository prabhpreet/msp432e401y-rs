...
pub struct R(crate::R<IF1MCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IF1MCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IF1MCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IF1MCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IF1MCTL` writer"]
pub struct W(crate::W<IF1MCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IF1MCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IF1MCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IF1MCTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CAN_IF1MCTL_DLC` reader - Data Length Code"]
pub type CAN_IF1MCTL_DLC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CAN_IF1MCTL_DLC` writer - Data Length Code"]
pub type CAN_IF1MCTL_DLC_W<'a> = crate::FieldWriter<'a, u32, IF1MCTL_SPEC, u8, u8, 4, 0>;
#[doc = "Field `CAN_IF1MCTL_EOB` reader - End of Buffer"]
pub type CAN_IF1MCTL_EOB_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_EOB` writer - End of Buffer"]
pub type CAN_IF1MCTL_EOB_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 7>;
#[doc = "Field `CAN_IF1MCTL_TXRQST` reader - Transmit Request"]
pub type CAN_IF1MCTL_TXRQST_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_TXRQST` writer - Transmit Request"]
pub type CAN_IF1MCTL_TXRQST_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 8>;
#[doc = "Field `CAN_IF1MCTL_RMTEN` reader - Remote Enable"]
pub type CAN_IF1MCTL_RMTEN_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_RMTEN` writer - Remote Enable"]
pub type CAN_IF1MCTL_RMTEN_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 9>;
#[doc = "Field `CAN_IF1MCTL_RXIE` reader - Receive Interrupt Enable"]
pub type CAN_IF1MCTL_RXIE_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_RXIE` writer - Receive Interrupt Enable"]
pub type CAN_IF1MCTL_RXIE_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 10>;
#[doc = "Field `CAN_IF1MCTL_TXIE` reader - Transmit Interrupt Enable"]
pub type CAN_IF1MCTL_TXIE_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_TXIE` writer - Transmit Interrupt Enable"]
pub type CAN_IF1MCTL_TXIE_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 11>;
#[doc = "Field `CAN_IF1MCTL_UMASK` reader - Use Acceptance Mask"]
pub type CAN_IF1MCTL_UMASK_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_UMASK` writer - Use Acceptance Mask"]
pub type CAN_IF1MCTL_UMASK_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 12>;
#[doc = "Field `CAN_IF1MCTL_INTPND` reader - Interrupt Pending"]
pub type CAN_IF1MCTL_INTPND_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_INTPND` writer - Interrupt Pending"]
pub type CAN_IF1MCTL_INTPND_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 13>;
#[doc = "Field `CAN_IF1MCTL_MSGLST` reader - Message Lost"]
pub type CAN_IF1MCTL_MSGLST_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_MSGLST` writer - Message Lost"]
pub type CAN_IF1MCTL_MSGLST_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 14>;
#[doc = "Field `CAN_IF1MCTL_NEWDAT` reader - New Data"]
pub type CAN_IF1MCTL_NEWDAT_R = crate::BitReader<bool>;
#[doc = "Field `CAN_IF1MCTL_NEWDAT` writer - New Data"]
pub type CAN_IF1MCTL_NEWDAT_W<'a> = crate::BitWriter<'a, u32, IF1MCTL_SPEC, bool, 15>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - Data Length Code"]
    #[inline(always)]
    pub fn can_if1mctl_dlc(&mut self) -> CAN_IF1MCTL_DLC_W {
        CAN_IF1MCTL_DLC_W::new(self)
    }
    #[doc = "Bit 7 - End of Buffer"]
    #[inline(always)]
    pub fn can_if1mctl_eob(&mut self) -> CAN_IF1MCTL_EOB_W {
        CAN_IF1MCTL_EOB_W::new(self)
    }
    #[doc = "Bit 8 - Transmit Request"]
    #[inline(always)]
    pub fn can_if1mctl_txrqst(&mut self) -> CAN_IF1MCTL_TXRQST_W {
        CAN_IF1MCTL_TXRQST_W::new(self)
    }
    #[doc = "Bit 9 - Remote Enable"]
    #[inline(always)]
    pub fn can_if1mctl_rmten(&mut self) -> CAN_IF1MCTL_RMTEN_W {
        CAN_IF1MCTL_RMTEN_W::new(self)
    }
    #[doc = "Bit 10 - Receive Interrupt Enable"]
    #[inline(always)]
    pub fn can_if1mctl_rxie(&mut self) -> CAN_IF1MCTL_RXIE_W {
        CAN_IF1MCTL_RXIE_W::new(self)
    }
    #[doc = "Bit 11 - Transmit Interrupt Enable"]
    #[inline(always)]
    pub fn can_if1mctl_txie(&mut self) -> CAN_IF1MCTL_TXIE_W {
        CAN_IF1MCTL_TXIE_W::new(self)
    }
    #[doc = "Bit 12 - Use Acceptance Mask"]
    #[inline(always)]
    pub fn can_if1mctl_umask(&mut self) -> CAN_IF1MCTL_UMASK_W {
        CAN_IF1MCTL_UMASK_W::new(self)
    }
    #[doc = "Bit 13 - Interrupt Pending"]
    #[inline(always)]
    pub fn can_if1mctl_intpnd(&mut self) -> CAN_IF1MCTL_INTPND_W {
        CAN_IF1MCTL_INTPND_W::new(self)
    }
    #[doc = "Bit 14 - Message Lost"]
    #[inline(always)]
    pub fn can_if1mctl_msglst(&mut self) -> CAN_IF1MCTL_MSGLST_W {
        CAN_IF1MCTL_MSGLST_W::new(self)
    }
    #[doc = "Bit 15 - New Data"]
    #[inline(always)]
    pub fn can_if1mctl_newdat(&mut self) -> CAN_IF1MCTL_NEWDAT_W {
