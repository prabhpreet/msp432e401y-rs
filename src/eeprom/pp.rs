...
pub type EEPROM_PP_SIZE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `EEPROM_PP_SIZE` writer - EEPROM Size"]
pub type EEPROM_PP_SIZE_W<'a> = crate::FieldWriter<'a, u32, PP_SPEC, u16, u16, 16, 0>;
impl R {
    #[doc = "Bits 0:15 - EEPROM Size"]
    #[inline(always)]
    pub fn eeprom_pp_size(&self) -> EEPROM_PP_SIZE_R {
        EEPROM_PP_SIZE_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - EEPROM Size"]
    #[inline(always)]
    pub fn eeprom_pp_size(&mut self) -> EEPROM_PP_SIZE_W {
