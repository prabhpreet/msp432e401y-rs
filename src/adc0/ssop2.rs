...
pub struct R(crate::R<SSOP2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SSOP2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SSOP2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SSOP2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SSOP2` writer"]
pub struct W(crate::W<SSOP2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SSOP2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    #[doc = "Bit 0 - Sample 0 Digital Comparator Operation"]
    #[inline(always)]
    pub fn adc_ssop2_s0dcop(&mut self) -> ADC_SSOP2_S0DCOP_W {
        ADC_SSOP2_S0DCOP_W::new(self)
    }
    #[doc = "Bit 4 - Sample 1 Digital Comparator Operation"]
    #[inline(always)]
    pub fn adc_ssop2_s1dcop(&mut self) -> ADC_SSOP2_S1DCOP_W {
        ADC_SSOP2_S1DCOP_W::new(self)
    }
    #[doc = "Bit 8 - Sample 2 Digital Comparator Operation"]
    #[inline(always)]
    pub fn adc_ssop2_s2dcop(&mut self) -> ADC_SSOP2_S2DCOP_W {
        ADC_SSOP2_S2DCOP_W::new(self)
    }
    #[doc = "Bit 12 - Sample 3 Digital Comparator Operation"]
    #[inline(always)]
    pub fn adc_ssop2_s3dcop(&mut self) -> ADC_SSOP2_S3DCOP_W {
