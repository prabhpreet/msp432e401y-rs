...
pub struct R(crate::R<SSDC1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SSDC1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SSDC1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SSDC1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SSDC1` writer"]
pub struct W(crate::W<SSDC1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SSDC1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SSDC1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SSDC1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ADC_SSDC1_S0DCSEL` reader - Sample 0 Digital Comparator Select"]
pub type ADC_SSDC1_S0DCSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADC_SSDC1_S0DCSEL` writer - Sample 0 Digital Comparator Select"]
pub type ADC_SSDC1_S0DCSEL_W<'a> = crate::FieldWriter<'a, u32, SSDC1_SPEC, u8, u8, 4, 0>;
#[doc = "Field `ADC_SSDC1_S1DCSEL` reader - Sample 1 Digital Comparator Select"]
pub type ADC_SSDC1_S1DCSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADC_SSDC1_S1DCSEL` writer - Sample 1 Digital Comparator Select"]
pub type ADC_SSDC1_S1DCSEL_W<'a> = crate::FieldWriter<'a, u32, SSDC1_SPEC, u8, u8, 4, 4>;
#[doc = "Field `ADC_SSDC1_S2DCSEL` reader - Sample 2 Digital Comparator Select"]
pub type ADC_SSDC1_S2DCSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADC_SSDC1_S2DCSEL` writer - Sample 2 Digital Comparator Select"]
pub type ADC_SSDC1_S2DCSEL_W<'a> = crate::FieldWriter<'a, u32, SSDC1_SPEC, u8, u8, 4, 8>;
#[doc = "Field `ADC_SSDC1_S3DCSEL` reader - Sample 3 Digital Comparator Select"]
pub type ADC_SSDC1_S3DCSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADC_SSDC1_S3DCSEL` writer - Sample 3 Digital Comparator Select"]
pub type ADC_SSDC1_S3DCSEL_W<'a> = crate::FieldWriter<'a, u32, SSDC1_SPEC, u8, u8, 4, 12>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - Sample 0 Digital Comparator Select"]
    #[inline(always)]
    pub fn adc_ssdc1_s0dcsel(&mut self) -> ADC_SSDC1_S0DCSEL_W {
        ADC_SSDC1_S0DCSEL_W::new(self)
    }
    #[doc = "Bits 4:7 - Sample 1 Digital Comparator Select"]
    #[inline(always)]
    pub fn adc_ssdc1_s1dcsel(&mut self) -> ADC_SSDC1_S1DCSEL_W {
        ADC_SSDC1_S1DCSEL_W::new(self)
    }
    #[doc = "Bits 8:11 - Sample 2 Digital Comparator Select"]
    #[inline(always)]
    pub fn adc_ssdc1_s2dcsel(&mut self) -> ADC_SSDC1_S2DCSEL_W {
        ADC_SSDC1_S2DCSEL_W::new(self)
    }
    #[doc = "Bits 12:15 - Sample 3 Digital Comparator Select"]
    #[inline(always)]
    pub fn adc_ssdc1_s3dcsel(&mut self) -> ADC_SSDC1_S3DCSEL_W {
