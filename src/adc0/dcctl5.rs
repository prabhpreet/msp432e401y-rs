...
pub struct R(crate::R<DCCTL5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCCTL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCCTL5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCCTL5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCCTL5` writer"]
pub struct W(crate::W<DCCTL5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCCTL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCCTL5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCCTL5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADC_DCCTL5_CIM_R = crate::FieldReader<u8, ADC_DCCTL5_CIM_A>;
impl ADC_DCCTL5_CIM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ADC_DCCTL5_CIM_A {
        match self.bits {
...
pub type ADC_DCCTL5_CIM_W<'a> =
    crate::FieldWriterSafe<'a, u32, DCCTL5_SPEC, u8, ADC_DCCTL5_CIM_A, 2, 0>;
impl<'a> ADC_DCCTL5_CIM_W<'a> {
    #[doc = "Always"]
    #[inline(always)]
...
pub type ADC_DCCTL5_CIC_R = crate::FieldReader<u8, ADC_DCCTL5_CIC_A>;
impl ADC_DCCTL5_CIC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ADC_DCCTL5_CIC_A> {
        match self.bits {
...
pub type ADC_DCCTL5_CIC_W<'a> =
    crate::FieldWriter<'a, u32, DCCTL5_SPEC, u8, ADC_DCCTL5_CIC_A, 2, 2>;
impl<'a> ADC_DCCTL5_CIC_W<'a> {
    #[doc = "Low Band"]
    #[inline(always)]
...
pub type ADC_DCCTL5_CIE_R = crate::BitReader<bool>;
#[doc = "Field `ADC_DCCTL5_CIE` writer - Comparison Interrupt Enable"]
pub type ADC_DCCTL5_CIE_W<'a> = crate::BitWriter<'a, u32, DCCTL5_SPEC, bool, 4>;
...
pub type ADC_DCCTL5_CTM_R = crate::FieldReader<u8, ADC_DCCTL5_CTM_A>;
impl ADC_DCCTL5_CTM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ADC_DCCTL5_CTM_A {
        match self.bits {
...
pub type ADC_DCCTL5_CTM_W<'a> =
    crate::FieldWriterSafe<'a, u32, DCCTL5_SPEC, u8, ADC_DCCTL5_CTM_A, 2, 8>;
impl<'a> ADC_DCCTL5_CTM_W<'a> {
    #[doc = "Always"]
    #[inline(always)]
...
pub type ADC_DCCTL5_CTC_R = crate::FieldReader<u8, ADC_DCCTL5_CTC_A>;
impl ADC_DCCTL5_CTC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ADC_DCCTL5_CTC_A> {
        match self.bits {
...
pub type ADC_DCCTL5_CTC_W<'a> =
    crate::FieldWriter<'a, u32, DCCTL5_SPEC, u8, ADC_DCCTL5_CTC_A, 2, 10>;
impl<'a> ADC_DCCTL5_CTC_W<'a> {
    #[doc = "Low Band"]
    #[inline(always)]
...
pub type ADC_DCCTL5_CTE_R = crate::BitReader<bool>;
#[doc = "Field `ADC_DCCTL5_CTE` writer - Comparison Trigger Enable"]
pub type ADC_DCCTL5_CTE_W<'a> = crate::BitWriter<'a, u32, DCCTL5_SPEC, bool, 12>;
impl R {
...
impl W {
    #[doc = "Bits 0:1 - Comparison Interrupt Mode"]
    #[inline(always)]
    pub fn adc_dcctl5_cim(&mut self) -> ADC_DCCTL5_CIM_W {
        ADC_DCCTL5_CIM_W::new(self)
    }
    #[doc = "Bits 2:3 - Comparison Interrupt Condition"]
    #[inline(always)]
    pub fn adc_dcctl5_cic(&mut self) -> ADC_DCCTL5_CIC_W {
        ADC_DCCTL5_CIC_W::new(self)
    }
    #[doc = "Bit 4 - Comparison Interrupt Enable"]
    #[inline(always)]
    pub fn adc_dcctl5_cie(&mut self) -> ADC_DCCTL5_CIE_W {
        ADC_DCCTL5_CIE_W::new(self)
    }
    #[doc = "Bits 8:9 - Comparison Trigger Mode"]
    #[inline(always)]
    pub fn adc_dcctl5_ctm(&mut self) -> ADC_DCCTL5_CTM_W {
        ADC_DCCTL5_CTM_W::new(self)
    }
    #[doc = "Bits 10:11 - Comparison Trigger Condition"]
    #[inline(always)]
    pub fn adc_dcctl5_ctc(&mut self) -> ADC_DCCTL5_CTC_W {
        ADC_DCCTL5_CTC_W::new(self)
    }
    #[doc = "Bit 12 - Comparison Trigger Enable"]
    #[inline(always)]
    pub fn adc_dcctl5_cte(&mut self) -> ADC_DCCTL5_CTE_W {
