...
pub struct R(crate::R<DCCTL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCCTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCCTL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCCTL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCCTL1` writer"]
pub struct W(crate::W<DCCTL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCCTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCCTL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCCTL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADC_DCCTL1_CIM_R = crate::FieldReader<u8, ADC_DCCTL1_CIM_A>;
impl ADC_DCCTL1_CIM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ADC_DCCTL1_CIM_A {
        match self.bits {
...
pub type ADC_DCCTL1_CIM_W<'a> =
    crate::FieldWriterSafe<'a, u32, DCCTL1_SPEC, u8, ADC_DCCTL1_CIM_A, 2, 0>;
impl<'a> ADC_DCCTL1_CIM_W<'a> {
    #[doc = "Always"]
    #[inline(always)]
    pub fn adc_dcctl1_cim_always(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CIM_A::ADC_DCCTL1_CIM_ALWAYS)
    }
    #[doc = "Once"]
    #[inline(always)]
    pub fn adc_dcctl1_cim_once(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CIM_A::ADC_DCCTL1_CIM_ONCE)
    }
    #[doc = "Hysteresis Always"]
    #[inline(always)]
    pub fn adc_dcctl1_cim_halways(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CIM_A::ADC_DCCTL1_CIM_HALWAYS)
    }
    #[doc = "Hysteresis Once"]
    #[inline(always)]
    pub fn adc_dcctl1_cim_honce(self) -> &'a mut W {
...
pub type ADC_DCCTL1_CIC_R = crate::FieldReader<u8, ADC_DCCTL1_CIC_A>;
impl ADC_DCCTL1_CIC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ADC_DCCTL1_CIC_A> {
        match self.bits {
    ...
    #[doc = "Checks if the value of the field is `ADC_DCCTL1_CIC_LOW`"]
    #[inline(always)]
    pub fn is_adc_dcctl1_cic_low(&self) -> bool {
        *self == ADC_DCCTL1_CIC_A::ADC_DCCTL1_CIC_LOW
    }
    #[doc = "Checks if the value of the field is `ADC_DCCTL1_CIC_MID`"]
    #[inline(always)]
    pub fn is_adc_dcctl1_cic_mid(&self) -> bool {
        *self == ADC_DCCTL1_CIC_A::ADC_DCCTL1_CIC_MID
    }
    #[doc = "Checks if the value of the field is `ADC_DCCTL1_CIC_HIGH`"]
    #[inline(always)]
...
pub type ADC_DCCTL1_CIC_W<'a> =
    crate::FieldWriter<'a, u32, DCCTL1_SPEC, u8, ADC_DCCTL1_CIC_A, 2, 2>;
impl<'a> ADC_DCCTL1_CIC_W<'a> {
    #[doc = "Low Band"]
    #[inline(always)]
    pub fn adc_dcctl1_cic_low(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CIC_A::ADC_DCCTL1_CIC_LOW)
    }
    #[doc = "Mid Band"]
    #[inline(always)]
    pub fn adc_dcctl1_cic_mid(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CIC_A::ADC_DCCTL1_CIC_MID)
    }
    #[doc = "High Band"]
    #[inline(always)]
    pub fn adc_dcctl1_cic_high(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CIC_A::ADC_DCCTL1_CIC_HIGH)
    }
}
#[doc = "Field `ADC_DCCTL1_CIE` reader - Comparison Interrupt Enable"]
pub type ADC_DCCTL1_CIE_R = crate::BitReader<bool>;
#[doc = "Field `ADC_DCCTL1_CIE` writer - Comparison Interrupt Enable"]
pub type ADC_DCCTL1_CIE_W<'a> = crate::BitWriter<'a, u32, DCCTL1_SPEC, bool, 4>;
...
pub type ADC_DCCTL1_CTM_R = crate::FieldReader<u8, ADC_DCCTL1_CTM_A>;
impl ADC_DCCTL1_CTM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ADC_DCCTL1_CTM_A {
        match self.bits {
...
pub type ADC_DCCTL1_CTM_W<'a> =
    crate::FieldWriterSafe<'a, u32, DCCTL1_SPEC, u8, ADC_DCCTL1_CTM_A, 2, 8>;
impl<'a> ADC_DCCTL1_CTM_W<'a> {
    #[doc = "Always"]
    #[inline(always)]
    pub fn adc_dcctl1_ctm_always(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CTM_A::ADC_DCCTL1_CTM_ALWAYS)
    }
    #[doc = "Once"]
    #[inline(always)]
    pub fn adc_dcctl1_ctm_once(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CTM_A::ADC_DCCTL1_CTM_ONCE)
    }
    #[doc = "Hysteresis Always"]
    #[inline(always)]
    pub fn adc_dcctl1_ctm_halways(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CTM_A::ADC_DCCTL1_CTM_HALWAYS)
    }
    #[doc = "Hysteresis Once"]
    #[inline(always)]
    pub fn adc_dcctl1_ctm_honce(self) -> &'a mut W {
...
pub type ADC_DCCTL1_CTC_R = crate::FieldReader<u8, ADC_DCCTL1_CTC_A>;
impl ADC_DCCTL1_CTC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ADC_DCCTL1_CTC_A> {
        match self.bits {
    ...
    #[doc = "Checks if the value of the field is `ADC_DCCTL1_CTC_LOW`"]
    #[inline(always)]
    pub fn is_adc_dcctl1_ctc_low(&self) -> bool {
        *self == ADC_DCCTL1_CTC_A::ADC_DCCTL1_CTC_LOW
    }
    #[doc = "Checks if the value of the field is `ADC_DCCTL1_CTC_MID`"]
    #[inline(always)]
    pub fn is_adc_dcctl1_ctc_mid(&self) -> bool {
        *self == ADC_DCCTL1_CTC_A::ADC_DCCTL1_CTC_MID
    }
    #[doc = "Checks if the value of the field is `ADC_DCCTL1_CTC_HIGH`"]
    #[inline(always)]
...
pub type ADC_DCCTL1_CTC_W<'a> =
    crate::FieldWriter<'a, u32, DCCTL1_SPEC, u8, ADC_DCCTL1_CTC_A, 2, 10>;
impl<'a> ADC_DCCTL1_CTC_W<'a> {
    #[doc = "Low Band"]
    #[inline(always)]
    pub fn adc_dcctl1_ctc_low(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CTC_A::ADC_DCCTL1_CTC_LOW)
    }
    #[doc = "Mid Band"]
    #[inline(always)]
    pub fn adc_dcctl1_ctc_mid(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CTC_A::ADC_DCCTL1_CTC_MID)
    }
    #[doc = "High Band"]
    #[inline(always)]
    pub fn adc_dcctl1_ctc_high(self) -> &'a mut W {
        self.variant(ADC_DCCTL1_CTC_A::ADC_DCCTL1_CTC_HIGH)
    }
}
#[doc = "Field `ADC_DCCTL1_CTE` reader - Comparison Trigger Enable"]
pub type ADC_DCCTL1_CTE_R = crate::BitReader<bool>;
#[doc = "Field `ADC_DCCTL1_CTE` writer - Comparison Trigger Enable"]
pub type ADC_DCCTL1_CTE_W<'a> = crate::BitWriter<'a, u32, DCCTL1_SPEC, bool, 12>;
impl R {
...
impl W {
    #[doc = "Bits 0:1 - Comparison Interrupt Mode"]
    #[inline(always)]
    pub fn adc_dcctl1_cim(&mut self) -> ADC_DCCTL1_CIM_W {
        ADC_DCCTL1_CIM_W::new(self)
    }
    #[doc = "Bits 2:3 - Comparison Interrupt Condition"]
    #[inline(always)]
    pub fn adc_dcctl1_cic(&mut self) -> ADC_DCCTL1_CIC_W {
        ADC_DCCTL1_CIC_W::new(self)
    }
    #[doc = "Bit 4 - Comparison Interrupt Enable"]
    #[inline(always)]
    pub fn adc_dcctl1_cie(&mut self) -> ADC_DCCTL1_CIE_W {
        ADC_DCCTL1_CIE_W::new(self)
    }
    #[doc = "Bits 8:9 - Comparison Trigger Mode"]
    #[inline(always)]
    pub fn adc_dcctl1_ctm(&mut self) -> ADC_DCCTL1_CTM_W {
        ADC_DCCTL1_CTM_W::new(self)
    }
    #[doc = "Bits 10:11 - Comparison Trigger Condition"]
    #[inline(always)]
    pub fn adc_dcctl1_ctc(&mut self) -> ADC_DCCTL1_CTC_W {
        ADC_DCCTL1_CTC_W::new(self)
    }
    #[doc = "Bit 12 - Comparison Trigger Enable"]
    #[inline(always)]
    pub fn adc_dcctl1_cte(&mut self) -> ADC_DCCTL1_CTE_W {
