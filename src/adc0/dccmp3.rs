...
pub struct R(crate::R<DCCMP3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCCMP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCCMP3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCCMP3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCCMP3` writer"]
pub struct W(crate::W<DCCMP3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCCMP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCCMP3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCCMP3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ADC_DCCMP3_COMP0` reader - Compare 0"]
pub type ADC_DCCMP3_COMP0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `ADC_DCCMP3_COMP0` writer - Compare 0"]
pub type ADC_DCCMP3_COMP0_W<'a> = crate::FieldWriter<'a, u32, DCCMP3_SPEC, u16, u16, 12, 0>;
#[doc = "Field `ADC_DCCMP3_COMP1` reader - Compare 1"]
pub type ADC_DCCMP3_COMP1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `ADC_DCCMP3_COMP1` writer - Compare 1"]
pub type ADC_DCCMP3_COMP1_W<'a> = crate::FieldWriter<'a, u32, DCCMP3_SPEC, u16, u16, 12, 16>;
impl R {
...
impl W {
    #[doc = "Bits 0:11 - Compare 0"]
    #[inline(always)]
    pub fn adc_dccmp3_comp0(&mut self) -> ADC_DCCMP3_COMP0_W {
        ADC_DCCMP3_COMP0_W::new(self)
    }
    #[doc = "Bits 16:27 - Compare 1"]
    #[inline(always)]
    pub fn adc_dccmp3_comp1(&mut self) -> ADC_DCCMP3_COMP1_W {
