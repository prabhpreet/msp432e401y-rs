...
pub struct R(crate::R<DCCTL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DCCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DCCTL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DCCTL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DCCTL0` writer"]
pub struct W(crate::W<DCCTL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DCCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DCCTL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DCCTL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADC_DCCTL0_CIM_R = crate::FieldReader<u8, ADC_DCCTL0_CIM_A>;
impl ADC_DCCTL0_CIM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ADC_DCCTL0_CIM_A {
        match self.bits {
...
pub type ADC_DCCTL0_CIM_W<'a> =
    crate::FieldWriterSafe<'a, u32, DCCTL0_SPEC, u8, ADC_DCCTL0_CIM_A, 2, 0>;
impl<'a> ADC_DCCTL0_CIM_W<'a> {
    #[doc = "Always"]
    #[inline(always)]
...
pub type ADC_DCCTL0_CIC_R = crate::FieldReader<u8, ADC_DCCTL0_CIC_A>;
impl ADC_DCCTL0_CIC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ADC_DCCTL0_CIC_A> {
        match self.bits {
...
pub type ADC_DCCTL0_CIC_W<'a> =
    crate::FieldWriter<'a, u32, DCCTL0_SPEC, u8, ADC_DCCTL0_CIC_A, 2, 2>;
impl<'a> ADC_DCCTL0_CIC_W<'a> {
    #[doc = "Low Band"]
    #[inline(always)]
...
pub type ADC_DCCTL0_CIE_R = crate::BitReader<bool>;
#[doc = "Field `ADC_DCCTL0_CIE` writer - Comparison Interrupt Enable"]
pub type ADC_DCCTL0_CIE_W<'a> = crate::BitWriter<'a, u32, DCCTL0_SPEC, bool, 4>;
...
pub type ADC_DCCTL0_CTM_R = crate::FieldReader<u8, ADC_DCCTL0_CTM_A>;
impl ADC_DCCTL0_CTM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> ADC_DCCTL0_CTM_A {
        match self.bits {
...
pub type ADC_DCCTL0_CTM_W<'a> =
    crate::FieldWriterSafe<'a, u32, DCCTL0_SPEC, u8, ADC_DCCTL0_CTM_A, 2, 8>;
impl<'a> ADC_DCCTL0_CTM_W<'a> {
    #[doc = "Always"]
    #[inline(always)]
...
pub type ADC_DCCTL0_CTC_R = crate::FieldReader<u8, ADC_DCCTL0_CTC_A>;
impl ADC_DCCTL0_CTC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ADC_DCCTL0_CTC_A> {
        match self.bits {
...
pub type ADC_DCCTL0_CTC_W<'a> =
    crate::FieldWriter<'a, u32, DCCTL0_SPEC, u8, ADC_DCCTL0_CTC_A, 2, 10>;
impl<'a> ADC_DCCTL0_CTC_W<'a> {
    #[doc = "Low Band"]
    #[inline(always)]
...
pub type ADC_DCCTL0_CTE_R = crate::BitReader<bool>;
#[doc = "Field `ADC_DCCTL0_CTE` writer - Comparison Trigger Enable"]
pub type ADC_DCCTL0_CTE_W<'a> = crate::BitWriter<'a, u32, DCCTL0_SPEC, bool, 12>;
impl R {
...
impl W {
    #[doc = "Bits 0:1 - Comparison Interrupt Mode"]
    #[inline(always)]
    pub fn adc_dcctl0_cim(&mut self) -> ADC_DCCTL0_CIM_W {
        ADC_DCCTL0_CIM_W::new(self)
    }
    #[doc = "Bits 2:3 - Comparison Interrupt Condition"]
    #[inline(always)]
    pub fn adc_dcctl0_cic(&mut self) -> ADC_DCCTL0_CIC_W {
        ADC_DCCTL0_CIC_W::new(self)
    }
    #[doc = "Bit 4 - Comparison Interrupt Enable"]
    #[inline(always)]
    pub fn adc_dcctl0_cie(&mut self) -> ADC_DCCTL0_CIE_W {
        ADC_DCCTL0_CIE_W::new(self)
    }
    #[doc = "Bits 8:9 - Comparison Trigger Mode"]
    #[inline(always)]
    pub fn adc_dcctl0_ctm(&mut self) -> ADC_DCCTL0_CTM_W {
        ADC_DCCTL0_CTM_W::new(self)
    }
    #[doc = "Bits 10:11 - Comparison Trigger Condition"]
    #[inline(always)]
    pub fn adc_dcctl0_ctc(&mut self) -> ADC_DCCTL0_CTC_W {
        ADC_DCCTL0_CTC_W::new(self)
    }
    #[doc = "Bit 12 - Comparison Trigger Enable"]
    #[inline(always)]
    pub fn adc_dcctl0_cte(&mut self) -> ADC_DCCTL0_CTE_W {
