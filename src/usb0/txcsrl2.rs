...
pub struct R(crate::R<TXCSRL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXCSRL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXCSRL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXCSRL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXCSRL2` writer"]
pub struct W(crate::W<TXCSRL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXCSRL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXCSRL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXCSRL2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXCSRL2_TXRDY` reader - Transmit Packet Ready"]
pub type USB_TXCSRL2_TXRDY_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_TXRDY` writer - Transmit Packet Ready"]
pub type USB_TXCSRL2_TXRDY_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 0>;
#[doc = "Field `USB_TXCSRL2_FIFONE` reader - FIFO Not Empty"]
pub type USB_TXCSRL2_FIFONE_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_FIFONE` writer - FIFO Not Empty"]
pub type USB_TXCSRL2_FIFONE_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 1>;
#[doc = "Field `USB_TXCSRL2_ERROR` reader - Error"]
pub type USB_TXCSRL2_ERROR_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_ERROR` writer - Error"]
pub type USB_TXCSRL2_ERROR_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 2>;
#[doc = "Field `USB_TXCSRL2_FLUSH` reader - Flush FIFO"]
pub type USB_TXCSRL2_FLUSH_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_FLUSH` writer - Flush FIFO"]
pub type USB_TXCSRL2_FLUSH_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 3>;
#[doc = "Field `USB_TXCSRL2_SETUP` reader - Setup Packet"]
pub type USB_TXCSRL2_SETUP_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_SETUP` writer - Setup Packet"]
pub type USB_TXCSRL2_SETUP_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 4>;
#[doc = "Field `USB_TXCSRL2_STALLED` reader - Endpoint Stalled"]
pub type USB_TXCSRL2_STALLED_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_STALLED` writer - Endpoint Stalled"]
pub type USB_TXCSRL2_STALLED_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 5>;
#[doc = "Field `USB_TXCSRL2_CLRDT` reader - Clear Data Toggle"]
pub type USB_TXCSRL2_CLRDT_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_CLRDT` writer - Clear Data Toggle"]
pub type USB_TXCSRL2_CLRDT_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 6>;
#[doc = "Field `USB_TXCSRL2_NAKTO` reader - NAK Timeout"]
pub type USB_TXCSRL2_NAKTO_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL2_NAKTO` writer - NAK Timeout"]
pub type USB_TXCSRL2_NAKTO_W<'a> = crate::BitWriter<'a, u8, TXCSRL2_SPEC, bool, 7>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Transmit Packet Ready"]
    #[inline(always)]
    pub fn usb_txcsrl2_txrdy(&mut self) -> USB_TXCSRL2_TXRDY_W {
        USB_TXCSRL2_TXRDY_W::new(self)
    }
    #[doc = "Bit 1 - FIFO Not Empty"]
    #[inline(always)]
    pub fn usb_txcsrl2_fifone(&mut self) -> USB_TXCSRL2_FIFONE_W {
        USB_TXCSRL2_FIFONE_W::new(self)
    }
    #[doc = "Bit 2 - Error"]
    #[inline(always)]
    pub fn usb_txcsrl2_error(&mut self) -> USB_TXCSRL2_ERROR_W {
        USB_TXCSRL2_ERROR_W::new(self)
    }
    #[doc = "Bit 3 - Flush FIFO"]
    #[inline(always)]
    pub fn usb_txcsrl2_flush(&mut self) -> USB_TXCSRL2_FLUSH_W {
        USB_TXCSRL2_FLUSH_W::new(self)
    }
    #[doc = "Bit 4 - Setup Packet"]
    #[inline(always)]
    pub fn usb_txcsrl2_setup(&mut self) -> USB_TXCSRL2_SETUP_W {
        USB_TXCSRL2_SETUP_W::new(self)
    }
    #[doc = "Bit 5 - Endpoint Stalled"]
    #[inline(always)]
    pub fn usb_txcsrl2_stalled(&mut self) -> USB_TXCSRL2_STALLED_W {
        USB_TXCSRL2_STALLED_W::new(self)
    }
    #[doc = "Bit 6 - Clear Data Toggle"]
    #[inline(always)]
    pub fn usb_txcsrl2_clrdt(&mut self) -> USB_TXCSRL2_CLRDT_W {
        USB_TXCSRL2_CLRDT_W::new(self)
    }
    #[doc = "Bit 7 - NAK Timeout"]
    #[inline(always)]
    pub fn usb_txcsrl2_nakto(&mut self) -> USB_TXCSRL2_NAKTO_W {
