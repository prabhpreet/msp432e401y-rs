...
pub struct R(crate::R<TXCSRL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXCSRL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXCSRL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXCSRL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXCSRL1` writer"]
pub struct W(crate::W<TXCSRL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXCSRL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXCSRL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXCSRL1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXCSRL1_TXRDY` reader - Transmit Packet Ready"]
pub type USB_TXCSRL1_TXRDY_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_TXRDY` writer - Transmit Packet Ready"]
pub type USB_TXCSRL1_TXRDY_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 0>;
#[doc = "Field `USB_TXCSRL1_FIFONE` reader - FIFO Not Empty"]
pub type USB_TXCSRL1_FIFONE_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_FIFONE` writer - FIFO Not Empty"]
pub type USB_TXCSRL1_FIFONE_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 1>;
#[doc = "Field `USB_TXCSRL1_ERROR` reader - Error"]
pub type USB_TXCSRL1_ERROR_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_ERROR` writer - Error"]
pub type USB_TXCSRL1_ERROR_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 2>;
#[doc = "Field `USB_TXCSRL1_FLUSH` reader - Flush FIFO"]
pub type USB_TXCSRL1_FLUSH_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_FLUSH` writer - Flush FIFO"]
pub type USB_TXCSRL1_FLUSH_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 3>;
#[doc = "Field `USB_TXCSRL1_SETUP` reader - Setup Packet"]
pub type USB_TXCSRL1_SETUP_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_SETUP` writer - Setup Packet"]
pub type USB_TXCSRL1_SETUP_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 4>;
#[doc = "Field `USB_TXCSRL1_STALLED` reader - Endpoint Stalled"]
pub type USB_TXCSRL1_STALLED_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_STALLED` writer - Endpoint Stalled"]
pub type USB_TXCSRL1_STALLED_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 5>;
#[doc = "Field `USB_TXCSRL1_CLRDT` reader - Clear Data Toggle"]
pub type USB_TXCSRL1_CLRDT_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_CLRDT` writer - Clear Data Toggle"]
pub type USB_TXCSRL1_CLRDT_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 6>;
#[doc = "Field `USB_TXCSRL1_NAKTO` reader - NAK Timeout"]
pub type USB_TXCSRL1_NAKTO_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL1_NAKTO` writer - NAK Timeout"]
pub type USB_TXCSRL1_NAKTO_W<'a> = crate::BitWriter<'a, u8, TXCSRL1_SPEC, bool, 7>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Transmit Packet Ready"]
    #[inline(always)]
    pub fn usb_txcsrl1_txrdy(&mut self) -> USB_TXCSRL1_TXRDY_W {
        USB_TXCSRL1_TXRDY_W::new(self)
    }
    #[doc = "Bit 1 - FIFO Not Empty"]
    #[inline(always)]
    pub fn usb_txcsrl1_fifone(&mut self) -> USB_TXCSRL1_FIFONE_W {
        USB_TXCSRL1_FIFONE_W::new(self)
    }
    #[doc = "Bit 2 - Error"]
    #[inline(always)]
    pub fn usb_txcsrl1_error(&mut self) -> USB_TXCSRL1_ERROR_W {
        USB_TXCSRL1_ERROR_W::new(self)
    }
    #[doc = "Bit 3 - Flush FIFO"]
    #[inline(always)]
    pub fn usb_txcsrl1_flush(&mut self) -> USB_TXCSRL1_FLUSH_W {
        USB_TXCSRL1_FLUSH_W::new(self)
    }
    #[doc = "Bit 4 - Setup Packet"]
    #[inline(always)]
    pub fn usb_txcsrl1_setup(&mut self) -> USB_TXCSRL1_SETUP_W {
        USB_TXCSRL1_SETUP_W::new(self)
    }
    #[doc = "Bit 5 - Endpoint Stalled"]
    #[inline(always)]
    pub fn usb_txcsrl1_stalled(&mut self) -> USB_TXCSRL1_STALLED_W {
        USB_TXCSRL1_STALLED_W::new(self)
    }
    #[doc = "Bit 6 - Clear Data Toggle"]
    #[inline(always)]
    pub fn usb_txcsrl1_clrdt(&mut self) -> USB_TXCSRL1_CLRDT_W {
        USB_TXCSRL1_CLRDT_W::new(self)
    }
    #[doc = "Bit 7 - NAK Timeout"]
    #[inline(always)]
    pub fn usb_txcsrl1_nakto(&mut self) -> USB_TXCSRL1_NAKTO_W {
