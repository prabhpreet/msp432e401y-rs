...
pub struct R(crate::R<TXMAXP5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXMAXP5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXMAXP5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXMAXP5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXMAXP5` writer"]
pub struct W(crate::W<TXMAXP5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXMAXP5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXMAXP5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXMAXP5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXMAXP5_MAXLOAD` reader - Maximum Payload"]
pub type USB_TXMAXP5_MAXLOAD_R = crate::FieldReader<u16, u16>;
#[doc = "Field `USB_TXMAXP5_MAXLOAD` writer - Maximum Payload"]
pub type USB_TXMAXP5_MAXLOAD_W<'a> = crate::FieldWriter<'a, u16, TXMAXP5_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    pub fn usb_txmaxp5_maxload(&self) -> USB_TXMAXP5_MAXLOAD_R {
        USB_TXMAXP5_MAXLOAD_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    pub fn usb_txmaxp5_maxload(&mut self) -> USB_TXMAXP5_MAXLOAD_W {
