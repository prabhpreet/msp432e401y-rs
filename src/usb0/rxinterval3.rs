...
pub struct R(crate::R<RXINTERVAL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXINTERVAL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXINTERVAL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXINTERVAL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXINTERVAL3` writer"]
pub struct W(crate::W<RXINTERVAL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXINTERVAL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXINTERVAL3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXINTERVAL3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXINTERVAL3_TXPOLL` reader - RX Polling"]
pub type USB_RXINTERVAL3_TXPOLL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_RXINTERVAL3_TXPOLL` writer - RX Polling"]
pub type USB_RXINTERVAL3_TXPOLL_W<'a> = crate::FieldWriter<'a, u8, RXINTERVAL3_SPEC, u8, u8, 8, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - RX Polling"]
    #[inline(always)]
    pub fn usb_rxinterval3_txpoll(&mut self) -> USB_RXINTERVAL3_TXPOLL_W {
