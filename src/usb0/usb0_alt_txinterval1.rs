...
pub struct R(crate::R<USB0_ALT_TXINTERVAL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB0_ALT_TXINTERVAL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB0_ALT_TXINTERVAL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB0_ALT_TXINTERVAL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXINTERVAL1` writer"]
pub struct W(crate::W<USB0_ALT_TXINTERVAL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB0_ALT_TXINTERVAL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB0_ALT_TXINTERVAL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB0_ALT_TXINTERVAL1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXINTERVAL1_NAKLMT` reader - NAK Limit"]
pub type USB_TXINTERVAL1_NAKLMT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_TXINTERVAL1_NAKLMT` writer - NAK Limit"]
pub type USB_TXINTERVAL1_NAKLMT_W<'a> =
    crate::FieldWriter<'a, u8, USB0_ALT_TXINTERVAL1_SPEC, u8, u8, 8, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - NAK Limit"]
    #[inline(always)]
    pub fn usb_txinterval1_naklmt(&mut self) -> USB_TXINTERVAL1_NAKLMT_W {
