...
pub struct R(crate::R<RXFUNCADDR5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXFUNCADDR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXFUNCADDR5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXFUNCADDR5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXFUNCADDR5` writer"]
pub struct W(crate::W<RXFUNCADDR5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXFUNCADDR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXFUNCADDR5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXFUNCADDR5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXFUNCADDR5_ADDR` reader - Device Address"]
pub type USB_RXFUNCADDR5_ADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_RXFUNCADDR5_ADDR` writer - Device Address"]
pub type USB_RXFUNCADDR5_ADDR_W<'a> = crate::FieldWriter<'a, u8, RXFUNCADDR5_SPEC, u8, u8, 7, 0>;
impl R {
    #[doc = "Bits 0:6 - Device Address"]
    #[inline(always)]
    pub fn usb_rxfuncaddr5_addr(&self) -> USB_RXFUNCADDR5_ADDR_R {
        USB_RXFUNCADDR5_ADDR_R::new((self.bits & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:6 - Device Address"]
    #[inline(always)]
    pub fn usb_rxfuncaddr5_addr(&mut self) -> USB_RXFUNCADDR5_ADDR_W {
