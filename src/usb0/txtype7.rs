...
pub struct R(crate::R<TXTYPE7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXTYPE7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXTYPE7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXTYPE7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXTYPE7` writer"]
pub struct W(crate::W<TXTYPE7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXTYPE7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXTYPE7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXTYPE7_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXTYPE7_TEP` reader - Target Endpoint Number"]
pub type USB_TXTYPE7_TEP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_TXTYPE7_TEP` writer - Target Endpoint Number"]
pub type USB_TXTYPE7_TEP_W<'a> = crate::FieldWriter<'a, u8, TXTYPE7_SPEC, u8, u8, 4, 0>;
#[doc = "Protocol\n\nValue on reset: 0"]
...
pub type USB_TXTYPE7_PROTO_R = crate::FieldReader<u8, USB_TXTYPE7_PROTO_A>;
impl USB_TXTYPE7_PROTO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USB_TXTYPE7_PROTO_A {
        match self.bits {
...
pub type USB_TXTYPE7_PROTO_W<'a> =
    crate::FieldWriterSafe<'a, u8, TXTYPE7_SPEC, u8, USB_TXTYPE7_PROTO_A, 2, 4>;
impl<'a> USB_TXTYPE7_PROTO_W<'a> {
    #[doc = "Control"]
    #[inline(always)]
    pub fn usb_txtype7_proto_ctrl(self) -> &'a mut W {
        self.variant(USB_TXTYPE7_PROTO_A::USB_TXTYPE7_PROTO_CTRL)
    }
    #[doc = "Isochronous"]
    #[inline(always)]
    pub fn usb_txtype7_proto_isoc(self) -> &'a mut W {
        self.variant(USB_TXTYPE7_PROTO_A::USB_TXTYPE7_PROTO_ISOC)
    }
    #[doc = "Bulk"]
    #[inline(always)]
    pub fn usb_txtype7_proto_bulk(self) -> &'a mut W {
        self.variant(USB_TXTYPE7_PROTO_A::USB_TXTYPE7_PROTO_BULK)
    }
    #[doc = "Interrupt"]
    #[inline(always)]
    pub fn usb_txtype7_proto_int(self) -> &'a mut W {
...
pub type USB_TXTYPE7_SPEED_R = crate::FieldReader<u8, USB_TXTYPE7_SPEED_A>;
impl USB_TXTYPE7_SPEED_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USB_TXTYPE7_SPEED_A {
        match self.bits {
            0 => USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_DFLT,
            1 => USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_HIGH,
            2 => USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_FULL,
            3 => USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_LOW,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `USB_TXTYPE7_SPEED_DFLT`"]
    #[inline(always)]
    pub fn is_usb_txtype7_speed_dflt(&self) -> bool {
        *self == USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_DFLT
    }
    #[doc = "Checks if the value of the field is `USB_TXTYPE7_SPEED_HIGH`"]
    #[inline(always)]
    pub fn is_usb_txtype7_speed_high(&self) -> bool {
        *self == USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_HIGH
    }
    #[doc = "Checks if the value of the field is `USB_TXTYPE7_SPEED_FULL`"]
    #[inline(always)]
    pub fn is_usb_txtype7_speed_full(&self) -> bool {
        *self == USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_FULL
    }
    #[doc = "Checks if the value of the field is `USB_TXTYPE7_SPEED_LOW`"]
    #[inline(always)]
...
pub type USB_TXTYPE7_SPEED_W<'a> =
    crate::FieldWriterSafe<'a, u8, TXTYPE7_SPEC, u8, USB_TXTYPE7_SPEED_A, 2, 6>;
impl<'a> USB_TXTYPE7_SPEED_W<'a> {
    #[doc = "Default"]
    #[inline(always)]
    pub fn usb_txtype7_speed_dflt(self) -> &'a mut W {
        self.variant(USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_DFLT)
    }
    #[doc = "High"]
    #[inline(always)]
    pub fn usb_txtype7_speed_high(self) -> &'a mut W {
        self.variant(USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_HIGH)
    }
    #[doc = "Full"]
    #[inline(always)]
    pub fn usb_txtype7_speed_full(self) -> &'a mut W {
        self.variant(USB_TXTYPE7_SPEED_A::USB_TXTYPE7_SPEED_FULL)
    }
    #[doc = "Low"]
    #[inline(always)]
    pub fn usb_txtype7_speed_low(self) -> &'a mut W {
...
impl R {
    ...
    pub fn usb_txtype7_tep(&self) -> USB_TXTYPE7_TEP_R {
        USB_TXTYPE7_TEP_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:5 - Protocol"]
    #[inline(always)]
    pub fn usb_txtype7_proto(&self) -> USB_TXTYPE7_PROTO_R {
        USB_TXTYPE7_PROTO_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7 - Operating Speed"]
    #[inline(always)]
    pub fn usb_txtype7_speed(&self) -> USB_TXTYPE7_SPEED_R {
        USB_TXTYPE7_SPEED_R::new(((self.bits >> 6) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - Target Endpoint Number"]
    #[inline(always)]
    pub fn usb_txtype7_tep(&mut self) -> USB_TXTYPE7_TEP_W {
        USB_TXTYPE7_TEP_W::new(self)
    }
    #[doc = "Bits 4:5 - Protocol"]
    #[inline(always)]
    pub fn usb_txtype7_proto(&mut self) -> USB_TXTYPE7_PROTO_W {
        USB_TXTYPE7_PROTO_W::new(self)
    }
    #[doc = "Bits 6:7 - Operating Speed"]
    #[inline(always)]
    pub fn usb_txtype7_speed(&mut self) -> USB_TXTYPE7_SPEED_W {
