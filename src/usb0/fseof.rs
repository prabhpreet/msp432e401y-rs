...
pub struct R(crate::R<FSEOF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FSEOF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FSEOF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FSEOF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FSEOF` writer"]
pub struct W(crate::W<FSEOF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FSEOF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FSEOF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FSEOF_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_FSEOF_FSEOFG` reader - Full-Speed End-of-Frame Gap"]
pub type USB_FSEOF_FSEOFG_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_FSEOF_FSEOFG` writer - Full-Speed End-of-Frame Gap"]
pub type USB_FSEOF_FSEOFG_W<'a> = crate::FieldWriter<'a, u8, FSEOF_SPEC, u8, u8, 8, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - Full-Speed End-of-Frame Gap"]
    #[inline(always)]
    pub fn usb_fseof_fseofg(&mut self) -> USB_FSEOF_FSEOFG_W {
