...
pub struct R(crate::R<TXHUBPORT6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXHUBPORT6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXHUBPORT6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXHUBPORT6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXHUBPORT6` writer"]
pub struct W(crate::W<TXHUBPORT6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXHUBPORT6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXHUBPORT6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXHUBPORT6_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXHUBPORT6_PORT` reader - Hub Port"]
pub type USB_TXHUBPORT6_PORT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_TXHUBPORT6_PORT` writer - Hub Port"]
pub type USB_TXHUBPORT6_PORT_W<'a> = crate::FieldWriter<'a, u8, TXHUBPORT6_SPEC, u8, u8, 7, 0>;
impl R {
    #[doc = "Bits 0:6 - Hub Port"]
    #[inline(always)]
    pub fn usb_txhubport6_port(&self) -> USB_TXHUBPORT6_PORT_R {
        USB_TXHUBPORT6_PORT_R::new((self.bits & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:6 - Hub Port"]
    #[inline(always)]
    pub fn usb_txhubport6_port(&mut self) -> USB_TXHUBPORT6_PORT_W {
