...
pub struct R(crate::R<RXMAXP6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXMAXP6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXMAXP6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXMAXP6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXMAXP6` writer"]
pub struct W(crate::W<RXMAXP6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXMAXP6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXMAXP6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXMAXP6_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXMAXP6_MAXLOAD` reader - Maximum Payload"]
pub type USB_RXMAXP6_MAXLOAD_R = crate::FieldReader<u16, u16>;
#[doc = "Field `USB_RXMAXP6_MAXLOAD` writer - Maximum Payload"]
pub type USB_RXMAXP6_MAXLOAD_W<'a> = crate::FieldWriter<'a, u16, RXMAXP6_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    pub fn usb_rxmaxp6_maxload(&self) -> USB_RXMAXP6_MAXLOAD_R {
        USB_RXMAXP6_MAXLOAD_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    pub fn usb_rxmaxp6_maxload(&mut self) -> USB_RXMAXP6_MAXLOAD_W {
