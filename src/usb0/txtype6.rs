...
pub struct R(crate::R<TXTYPE6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXTYPE6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXTYPE6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXTYPE6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXTYPE6` writer"]
pub struct W(crate::W<TXTYPE6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXTYPE6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXTYPE6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXTYPE6_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXTYPE6_TEP` reader - Target Endpoint Number"]
pub type USB_TXTYPE6_TEP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_TXTYPE6_TEP` writer - Target Endpoint Number"]
pub type USB_TXTYPE6_TEP_W<'a> = crate::FieldWriter<'a, u8, TXTYPE6_SPEC, u8, u8, 4, 0>;
#[doc = "Protocol\n\nValue on reset: 0"]
...
pub type USB_TXTYPE6_PROTO_R = crate::FieldReader<u8, USB_TXTYPE6_PROTO_A>;
impl USB_TXTYPE6_PROTO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USB_TXTYPE6_PROTO_A {
        match self.bits {
...
pub type USB_TXTYPE6_PROTO_W<'a> =
    crate::FieldWriterSafe<'a, u8, TXTYPE6_SPEC, u8, USB_TXTYPE6_PROTO_A, 2, 4>;
impl<'a> USB_TXTYPE6_PROTO_W<'a> {
    #[doc = "Control"]
    #[inline(always)]
...
pub type USB_TXTYPE6_SPEED_R = crate::FieldReader<u8, USB_TXTYPE6_SPEED_A>;
impl USB_TXTYPE6_SPEED_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USB_TXTYPE6_SPEED_A {
        match self.bits {
            0 => USB_TXTYPE6_SPEED_A::USB_TXTYPE6_SPEED_DFLT,
            1 => USB_TXTYPE6_SPEED_A::USB_TXTYPE6_SPEED_HIGH,
            2 => USB_TXTYPE6_SPEED_A::USB_TXTYPE6_SPEED_FULL,
            3 => USB_TXTYPE6_SPEED_A::USB_TXTYPE6_SPEED_LOW,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_usb_txtype6_speed_high(&self) -> bool {
        *self == USB_TXTYPE6_SPEED_A::USB_TXTYPE6_SPEED_HIGH
    }
...
pub type USB_TXTYPE6_SPEED_W<'a> =
    crate::FieldWriterSafe<'a, u8, TXTYPE6_SPEC, u8, USB_TXTYPE6_SPEED_A, 2, 6>;
impl<'a> USB_TXTYPE6_SPEED_W<'a> {
    #[doc = "Default"]
    #[inline(always)]
    ...
    pub fn usb_txtype6_speed_high(self) -> &'a mut W {
        self.variant(USB_TXTYPE6_SPEED_A::USB_TXTYPE6_SPEED_HIGH)
    }
    #[doc = "Full"]
    #[inline(always)]
...
impl R {
    ...
    pub fn usb_txtype6_tep(&self) -> USB_TXTYPE6_TEP_R {
        USB_TXTYPE6_TEP_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:5 - Protocol"]
    #[inline(always)]
    pub fn usb_txtype6_proto(&self) -> USB_TXTYPE6_PROTO_R {
        USB_TXTYPE6_PROTO_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7 - Operating Speed"]
    #[inline(always)]
    pub fn usb_txtype6_speed(&self) -> USB_TXTYPE6_SPEED_R {
        USB_TXTYPE6_SPEED_R::new(((self.bits >> 6) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - Target Endpoint Number"]
    #[inline(always)]
    pub fn usb_txtype6_tep(&mut self) -> USB_TXTYPE6_TEP_W {
        USB_TXTYPE6_TEP_W::new(self)
    }
    #[doc = "Bits 4:5 - Protocol"]
    #[inline(always)]
    pub fn usb_txtype6_proto(&mut self) -> USB_TXTYPE6_PROTO_W {
        USB_TXTYPE6_PROTO_W::new(self)
    }
    #[doc = "Bits 6:7 - Operating Speed"]
    #[inline(always)]
    pub fn usb_txtype6_speed(&mut self) -> USB_TXTYPE6_SPEED_W {
