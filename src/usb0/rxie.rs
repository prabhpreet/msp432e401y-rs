...
pub struct R(crate::R<RXIE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXIE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXIE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXIE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXIE` writer"]
pub struct W(crate::W<RXIE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXIE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    #[doc = "Bit 1 - RX Endpoint 1 Interrupt Enable"]
    #[inline(always)]
    pub fn usb_rxie_ep1(&mut self) -> USB_RXIE_EP1_W {
        USB_RXIE_EP1_W::new(self)
    }
    #[doc = "Bit 2 - RX Endpoint 2 Interrupt Enable"]
    #[inline(always)]
    pub fn usb_rxie_ep2(&mut self) -> USB_RXIE_EP2_W {
        USB_RXIE_EP2_W::new(self)
    }
    #[doc = "Bit 3 - RX Endpoint 3 Interrupt Enable"]
    #[inline(always)]
    pub fn usb_rxie_ep3(&mut self) -> USB_RXIE_EP3_W {
        USB_RXIE_EP3_W::new(self)
    }
    #[doc = "Bit 4 - RX Endpoint 4 Interrupt Enable"]
    #[inline(always)]
    pub fn usb_rxie_ep4(&mut self) -> USB_RXIE_EP4_W {
        USB_RXIE_EP4_W::new(self)
    }
    #[doc = "Bit 5 - RX Endpoint 5 Interrupt Enable"]
    #[inline(always)]
    pub fn usb_rxie_ep5(&mut self) -> USB_RXIE_EP5_W {
        USB_RXIE_EP5_W::new(self)
    }
    #[doc = "Bit 6 - RX Endpoint 6 Interrupt Enable"]
    #[inline(always)]
    pub fn usb_rxie_ep6(&mut self) -> USB_RXIE_EP6_W {
        USB_RXIE_EP6_W::new(self)
    }
    #[doc = "Bit 7 - RX Endpoint 7 Interrupt Enable"]
    #[inline(always)]
    pub fn usb_rxie_ep7(&mut self) -> USB_RXIE_EP7_W {
