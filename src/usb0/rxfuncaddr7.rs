...
pub struct R(crate::R<RXFUNCADDR7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXFUNCADDR7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXFUNCADDR7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXFUNCADDR7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXFUNCADDR7` writer"]
pub struct W(crate::W<RXFUNCADDR7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXFUNCADDR7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXFUNCADDR7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXFUNCADDR7_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXFUNCADDR7_ADDR` reader - Device Address"]
pub type USB_RXFUNCADDR7_ADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_RXFUNCADDR7_ADDR` writer - Device Address"]
pub type USB_RXFUNCADDR7_ADDR_W<'a> = crate::FieldWriter<'a, u8, RXFUNCADDR7_SPEC, u8, u8, 7, 0>;
impl R {
    #[doc = "Bits 0:6 - Device Address"]
    #[inline(always)]
    pub fn usb_rxfuncaddr7_addr(&self) -> USB_RXFUNCADDR7_ADDR_R {
        USB_RXFUNCADDR7_ADDR_R::new((self.bits & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:6 - Device Address"]
    #[inline(always)]
    pub fn usb_rxfuncaddr7_addr(&mut self) -> USB_RXFUNCADDR7_ADDR_W {
