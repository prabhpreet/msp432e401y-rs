...
pub struct R(crate::R<RXTYPE5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXTYPE5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXTYPE5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXTYPE5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXTYPE5` writer"]
pub struct W(crate::W<RXTYPE5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXTYPE5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXTYPE5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXTYPE5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXTYPE5_TEP` reader - Target Endpoint Number"]
pub type USB_RXTYPE5_TEP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_RXTYPE5_TEP` writer - Target Endpoint Number"]
pub type USB_RXTYPE5_TEP_W<'a> = crate::FieldWriter<'a, u8, RXTYPE5_SPEC, u8, u8, 4, 0>;
#[doc = "Protocol\n\nValue on reset: 0"]
...
pub type USB_RXTYPE5_PROTO_R = crate::FieldReader<u8, USB_RXTYPE5_PROTO_A>;
impl USB_RXTYPE5_PROTO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USB_RXTYPE5_PROTO_A {
        match self.bits {
...
pub type USB_RXTYPE5_PROTO_W<'a> =
    crate::FieldWriterSafe<'a, u8, RXTYPE5_SPEC, u8, USB_RXTYPE5_PROTO_A, 2, 4>;
impl<'a> USB_RXTYPE5_PROTO_W<'a> {
    #[doc = "Control"]
    #[inline(always)]
...
pub type USB_RXTYPE5_SPEED_R = crate::FieldReader<u8, USB_RXTYPE5_SPEED_A>;
impl USB_RXTYPE5_SPEED_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USB_RXTYPE5_SPEED_A {
        match self.bits {
            0 => USB_RXTYPE5_SPEED_A::USB_RXTYPE5_SPEED_DFLT,
            1 => USB_RXTYPE5_SPEED_A::USB_RXTYPE5_SPEED_HIGH,
            2 => USB_RXTYPE5_SPEED_A::USB_RXTYPE5_SPEED_FULL,
            3 => USB_RXTYPE5_SPEED_A::USB_RXTYPE5_SPEED_LOW,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_usb_rxtype5_speed_high(&self) -> bool {
        *self == USB_RXTYPE5_SPEED_A::USB_RXTYPE5_SPEED_HIGH
    }
...
pub type USB_RXTYPE5_SPEED_W<'a> =
    crate::FieldWriterSafe<'a, u8, RXTYPE5_SPEC, u8, USB_RXTYPE5_SPEED_A, 2, 6>;
impl<'a> USB_RXTYPE5_SPEED_W<'a> {
    #[doc = "Default"]
    #[inline(always)]
    ...
    pub fn usb_rxtype5_speed_high(self) -> &'a mut W {
        self.variant(USB_RXTYPE5_SPEED_A::USB_RXTYPE5_SPEED_HIGH)
    }
    #[doc = "Full"]
    #[inline(always)]
...
impl R {
    ...
    pub fn usb_rxtype5_tep(&self) -> USB_RXTYPE5_TEP_R {
        USB_RXTYPE5_TEP_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:5 - Protocol"]
    #[inline(always)]
    pub fn usb_rxtype5_proto(&self) -> USB_RXTYPE5_PROTO_R {
        USB_RXTYPE5_PROTO_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7 - Operating Speed"]
    #[inline(always)]
    pub fn usb_rxtype5_speed(&self) -> USB_RXTYPE5_SPEED_R {
        USB_RXTYPE5_SPEED_R::new(((self.bits >> 6) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - Target Endpoint Number"]
    #[inline(always)]
    pub fn usb_rxtype5_tep(&mut self) -> USB_RXTYPE5_TEP_W {
        USB_RXTYPE5_TEP_W::new(self)
    }
    #[doc = "Bits 4:5 - Protocol"]
    #[inline(always)]
    pub fn usb_rxtype5_proto(&mut self) -> USB_RXTYPE5_PROTO_W {
        USB_RXTYPE5_PROTO_W::new(self)
    }
    #[doc = "Bits 6:7 - Operating Speed"]
    #[inline(always)]
    pub fn usb_rxtype5_speed(&mut self) -> USB_RXTYPE5_SPEED_W {
