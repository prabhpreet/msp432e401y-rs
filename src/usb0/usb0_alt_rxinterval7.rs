...
pub struct R(crate::R<USB0_ALT_RXINTERVAL7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB0_ALT_RXINTERVAL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB0_ALT_RXINTERVAL7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB0_ALT_RXINTERVAL7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXINTERVAL7` writer"]
pub struct W(crate::W<USB0_ALT_RXINTERVAL7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB0_ALT_RXINTERVAL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB0_ALT_RXINTERVAL7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB0_ALT_RXINTERVAL7_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXINTERVAL7_NAKLMT` reader - NAK Limit"]
pub type USB_RXINTERVAL7_NAKLMT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_RXINTERVAL7_NAKLMT` writer - NAK Limit"]
pub type USB_RXINTERVAL7_NAKLMT_W<'a> =
    crate::FieldWriter<'a, u8, USB0_ALT_RXINTERVAL7_SPEC, u8, u8, 8, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - NAK Limit"]
    #[inline(always)]
    pub fn usb_rxinterval7_naklmt(&mut self) -> USB_RXINTERVAL7_NAKLMT_W {
