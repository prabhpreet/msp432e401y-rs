...
pub struct R(crate::R<USB0_ALT_RXCSRL4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB0_ALT_RXCSRL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB0_ALT_RXCSRL4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB0_ALT_RXCSRL4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXCSRL4` writer"]
pub struct W(crate::W<USB0_ALT_RXCSRL4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB0_ALT_RXCSRL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB0_ALT_RXCSRL4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB0_ALT_RXCSRL4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXCSRL4_ERROR` reader - Error"]
pub type USB_RXCSRL4_ERROR_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRL4_ERROR` writer - Error"]
pub type USB_RXCSRL4_ERROR_W<'a> = crate::BitWriter<'a, u8, USB0_ALT_RXCSRL4_SPEC, bool, 2>;
#[doc = "Field `USB_RXCSRL4_NAKTO` reader - NAK Timeout"]
pub type USB_RXCSRL4_NAKTO_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRL4_NAKTO` writer - NAK Timeout"]
pub type USB_RXCSRL4_NAKTO_W<'a> = crate::BitWriter<'a, u8, USB0_ALT_RXCSRL4_SPEC, bool, 3>;
#[doc = "Field `USB_RXCSRL4_REQPKT` reader - Request Packet"]
pub type USB_RXCSRL4_REQPKT_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRL4_REQPKT` writer - Request Packet"]
pub type USB_RXCSRL4_REQPKT_W<'a> = crate::BitWriter<'a, u8, USB0_ALT_RXCSRL4_SPEC, bool, 5>;
impl R {
    #[doc = "Bit 2 - Error"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 2 - Error"]
    #[inline(always)]
    pub fn usb_rxcsrl4_error(&mut self) -> USB_RXCSRL4_ERROR_W {
        USB_RXCSRL4_ERROR_W::new(self)
    }
    #[doc = "Bit 3 - NAK Timeout"]
    #[inline(always)]
    pub fn usb_rxcsrl4_nakto(&mut self) -> USB_RXCSRL4_NAKTO_W {
        USB_RXCSRL4_NAKTO_W::new(self)
    }
    #[doc = "Bit 5 - Request Packet"]
    #[inline(always)]
    pub fn usb_rxcsrl4_reqpkt(&mut self) -> USB_RXCSRL4_REQPKT_W {
