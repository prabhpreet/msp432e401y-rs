...
pub struct R(crate::R<RXMAXP3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXMAXP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXMAXP3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXMAXP3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXMAXP3` writer"]
pub struct W(crate::W<RXMAXP3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXMAXP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXMAXP3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXMAXP3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXMAXP3_MAXLOAD` reader - Maximum Payload"]
pub type USB_RXMAXP3_MAXLOAD_R = crate::FieldReader<u16, u16>;
#[doc = "Field `USB_RXMAXP3_MAXLOAD` writer - Maximum Payload"]
pub type USB_RXMAXP3_MAXLOAD_W<'a> = crate::FieldWriter<'a, u16, RXMAXP3_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    pub fn usb_rxmaxp3_maxload(&self) -> USB_RXMAXP3_MAXLOAD_R {
        USB_RXMAXP3_MAXLOAD_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - Maximum Payload"]
    #[inline(always)]
    pub fn usb_rxmaxp3_maxload(&mut self) -> USB_RXMAXP3_MAXLOAD_W {
