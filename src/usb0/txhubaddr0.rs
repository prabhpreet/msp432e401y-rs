...
pub struct R(crate::R<TXHUBADDR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXHUBADDR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXHUBADDR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXHUBADDR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXHUBADDR0` writer"]
pub struct W(crate::W<TXHUBADDR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXHUBADDR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXHUBADDR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXHUBADDR0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXHUBADDR0_ADDR` reader - Hub Address"]
pub type USB_TXHUBADDR0_ADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_TXHUBADDR0_ADDR` writer - Hub Address"]
pub type USB_TXHUBADDR0_ADDR_W<'a> = crate::FieldWriter<'a, u8, TXHUBADDR0_SPEC, u8, u8, 7, 0>;
impl R {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    pub fn usb_txhubaddr0_addr(&self) -> USB_TXHUBADDR0_ADDR_R {
        USB_TXHUBADDR0_ADDR_R::new((self.bits & 0x7f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:6 - Hub Address"]
    #[inline(always)]
    pub fn usb_txhubaddr0_addr(&mut self) -> USB_TXHUBADDR0_ADDR_W {
