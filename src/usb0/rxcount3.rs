...
pub struct R(crate::R<RXCOUNT3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXCOUNT3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXCOUNT3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXCOUNT3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXCOUNT3` writer"]
pub struct W(crate::W<RXCOUNT3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXCOUNT3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXCOUNT3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXCOUNT3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXCOUNT3_COUNT` reader - Receive Packet Count"]
pub type USB_RXCOUNT3_COUNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `USB_RXCOUNT3_COUNT` writer - Receive Packet Count"]
pub type USB_RXCOUNT3_COUNT_W<'a> = crate::FieldWriter<'a, u16, RXCOUNT3_SPEC, u16, u16, 13, 0>;
impl R {
    #[doc = "Bits 0:12 - Receive Packet Count"]
    #[inline(always)]
    pub fn usb_rxcount3_count(&self) -> USB_RXCOUNT3_COUNT_R {
        USB_RXCOUNT3_COUNT_R::new((self.bits & 0x1fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:12 - Receive Packet Count"]
    #[inline(always)]
    pub fn usb_rxcount3_count(&mut self) -> USB_RXCOUNT3_COUNT_W {
