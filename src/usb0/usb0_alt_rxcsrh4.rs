...
pub struct R(crate::R<USB0_ALT_RXCSRH4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB0_ALT_RXCSRH4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB0_ALT_RXCSRH4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB0_ALT_RXCSRH4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXCSRH4` writer"]
pub struct W(crate::W<USB0_ALT_RXCSRH4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB0_ALT_RXCSRH4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB0_ALT_RXCSRH4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB0_ALT_RXCSRH4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXCSRH4_DISNYET` reader - Disable NYET"]
pub type USB_RXCSRH4_DISNYET_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH4_DISNYET` writer - Disable NYET"]
pub type USB_RXCSRH4_DISNYET_W<'a> = crate::BitWriter<'a, u8, USB0_ALT_RXCSRH4_SPEC, bool, 4>;
#[doc = "Field `USB_RXCSRH4_ISO` reader - Isochronous Transfers"]
pub type USB_RXCSRH4_ISO_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH4_ISO` writer - Isochronous Transfers"]
pub type USB_RXCSRH4_ISO_W<'a> = crate::BitWriter<'a, u8, USB0_ALT_RXCSRH4_SPEC, bool, 6>;
impl R {
...
impl W {
    #[doc = "Bit 4 - Disable NYET"]
    #[inline(always)]
    pub fn usb_rxcsrh4_disnyet(&mut self) -> USB_RXCSRH4_DISNYET_W {
        USB_RXCSRH4_DISNYET_W::new(self)
    }
    #[doc = "Bit 6 - Isochronous Transfers"]
    #[inline(always)]
    pub fn usb_rxcsrh4_iso(&mut self) -> USB_RXCSRH4_ISO_W {
