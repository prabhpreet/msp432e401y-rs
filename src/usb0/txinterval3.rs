...
pub struct R(crate::R<TXINTERVAL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXINTERVAL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXINTERVAL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXINTERVAL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXINTERVAL3` writer"]
pub struct W(crate::W<TXINTERVAL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXINTERVAL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXINTERVAL3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXINTERVAL3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXINTERVAL3_TXPOLL` reader - TX Polling"]
pub type USB_TXINTERVAL3_TXPOLL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USB_TXINTERVAL3_TXPOLL` writer - TX Polling"]
pub type USB_TXINTERVAL3_TXPOLL_W<'a> = crate::FieldWriter<'a, u8, TXINTERVAL3_SPEC, u8, u8, 8, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - TX Polling"]
    #[inline(always)]
    pub fn usb_txinterval3_txpoll(&mut self) -> USB_TXINTERVAL3_TXPOLL_W {
