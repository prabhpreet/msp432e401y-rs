...
#[doc = "Field `USB_DMAADDR1_ADDR` reader - DMA Address"]
pub type USB_DMAADDR1_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `USB_DMAADDR1_ADDR` writer - DMA Address"]
pub type USB_DMAADDR1_ADDR_W<'a> = crate::FieldWriter<'a, u32, DMAADDR1_SPEC, u32, u32, 30, 2>;
impl R {
    #[doc = "Bits 2:31 - DMA Address"]
    #[inline(always)]
    pub fn usb_dmaaddr1_addr(&self) -> USB_DMAADDR1_ADDR_R {
        USB_DMAADDR1_ADDR_R::new(((self.bits >> 2) & 0x3fff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 2:31 - DMA Address"]
    #[inline(always)]
    pub fn usb_dmaaddr1_addr(&mut self) -> USB_DMAADDR1_ADDR_W {
        USB_DMAADDR1_ADDR_W::new(self)
    }
