...
pub struct R(crate::R<USB0_ALT_TXCSRL4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB0_ALT_TXCSRL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB0_ALT_TXCSRL4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB0_ALT_TXCSRL4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXCSRL4` writer"]
pub struct W(crate::W<USB0_ALT_TXCSRL4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB0_ALT_TXCSRL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB0_ALT_TXCSRL4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB0_ALT_TXCSRL4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_TXCSRL4_UNDRN` reader - Underrun"]
pub type USB_TXCSRL4_UNDRN_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL4_UNDRN` writer - Underrun"]
pub type USB_TXCSRL4_UNDRN_W<'a> = crate::BitWriter<'a, u8, USB0_ALT_TXCSRL4_SPEC, bool, 2>;
#[doc = "Field `USB_TXCSRL4_STALL` reader - Send STALL"]
pub type USB_TXCSRL4_STALL_R = crate::BitReader<bool>;
#[doc = "Field `USB_TXCSRL4_STALL` writer - Send STALL"]
pub type USB_TXCSRL4_STALL_W<'a> = crate::BitWriter<'a, u8, USB0_ALT_TXCSRL4_SPEC, bool, 4>;
impl R {
    #[doc = "Bit 2 - Underrun"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 2 - Underrun"]
    #[inline(always)]
    pub fn usb_txcsrl4_undrn(&mut self) -> USB_TXCSRL4_UNDRN_W {
        USB_TXCSRL4_UNDRN_W::new(self)
    }
    #[doc = "Bit 4 - Send STALL"]
    #[inline(always)]
    pub fn usb_txcsrl4_stall(&mut self) -> USB_TXCSRL4_STALL_W {
