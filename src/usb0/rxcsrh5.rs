...
pub struct R(crate::R<RXCSRH5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXCSRH5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXCSRH5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXCSRH5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXCSRH5` writer"]
pub struct W(crate::W<RXCSRH5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXCSRH5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXCSRH5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXCSRH5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `USB_RXCSRH5_INCOMPRX` reader - Incomplete RX Transmission Status"]
pub type USB_RXCSRH5_INCOMPRX_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_INCOMPRX` writer - Incomplete RX Transmission Status"]
pub type USB_RXCSRH5_INCOMPRX_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 0>;
#[doc = "Field `USB_RXCSRH5_DT` reader - Data Toggle"]
pub type USB_RXCSRH5_DT_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_DT` writer - Data Toggle"]
pub type USB_RXCSRH5_DT_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 1>;
#[doc = "Field `USB_RXCSRH5_DTWE` reader - Data Toggle Write Enable"]
pub type USB_RXCSRH5_DTWE_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_DTWE` writer - Data Toggle Write Enable"]
pub type USB_RXCSRH5_DTWE_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 2>;
#[doc = "Field `USB_RXCSRH5_DMAMOD` reader - DMA Request Mode"]
pub type USB_RXCSRH5_DMAMOD_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_DMAMOD` writer - DMA Request Mode"]
pub type USB_RXCSRH5_DMAMOD_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 3>;
#[doc = "Field `USB_RXCSRH5_PIDERR` reader - PID Error"]
pub type USB_RXCSRH5_PIDERR_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_PIDERR` writer - PID Error"]
pub type USB_RXCSRH5_PIDERR_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 4>;
#[doc = "Field `USB_RXCSRH5_DMAEN` reader - DMA Request Enable"]
pub type USB_RXCSRH5_DMAEN_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_DMAEN` writer - DMA Request Enable"]
pub type USB_RXCSRH5_DMAEN_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 5>;
#[doc = "Field `USB_RXCSRH5_AUTORQ` reader - Auto Request"]
pub type USB_RXCSRH5_AUTORQ_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_AUTORQ` writer - Auto Request"]
pub type USB_RXCSRH5_AUTORQ_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 6>;
#[doc = "Field `USB_RXCSRH5_AUTOCL` reader - Auto Clear"]
pub type USB_RXCSRH5_AUTOCL_R = crate::BitReader<bool>;
#[doc = "Field `USB_RXCSRH5_AUTOCL` writer - Auto Clear"]
pub type USB_RXCSRH5_AUTOCL_W<'a> = crate::BitWriter<'a, u8, RXCSRH5_SPEC, bool, 7>;
impl R {
    #[doc = "Bit 0 - Incomplete RX Transmission Status"]
    #[inline(always)]
    pub fn usb_rxcsrh5_incomprx(&self) -> USB_RXCSRH5_INCOMPRX_R {
        USB_RXCSRH5_INCOMPRX_R::new((self.bits & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Incomplete RX Transmission Status"]
    #[inline(always)]
    pub fn usb_rxcsrh5_incomprx(&mut self) -> USB_RXCSRH5_INCOMPRX_W {
        USB_RXCSRH5_INCOMPRX_W::new(self)
    }
    #[doc = "Bit 1 - Data Toggle"]
    #[inline(always)]
    pub fn usb_rxcsrh5_dt(&mut self) -> USB_RXCSRH5_DT_W {
        USB_RXCSRH5_DT_W::new(self)
    }
    #[doc = "Bit 2 - Data Toggle Write Enable"]
    #[inline(always)]
    pub fn usb_rxcsrh5_dtwe(&mut self) -> USB_RXCSRH5_DTWE_W {
        USB_RXCSRH5_DTWE_W::new(self)
    }
    #[doc = "Bit 3 - DMA Request Mode"]
    #[inline(always)]
    pub fn usb_rxcsrh5_dmamod(&mut self) -> USB_RXCSRH5_DMAMOD_W {
        USB_RXCSRH5_DMAMOD_W::new(self)
    }
    #[doc = "Bit 4 - PID Error"]
    #[inline(always)]
    pub fn usb_rxcsrh5_piderr(&mut self) -> USB_RXCSRH5_PIDERR_W {
        USB_RXCSRH5_PIDERR_W::new(self)
    }
    #[doc = "Bit 5 - DMA Request Enable"]
    #[inline(always)]
    pub fn usb_rxcsrh5_dmaen(&mut self) -> USB_RXCSRH5_DMAEN_W {
        USB_RXCSRH5_DMAEN_W::new(self)
    }
    #[doc = "Bit 6 - Auto Request"]
    #[inline(always)]
    pub fn usb_rxcsrh5_autorq(&mut self) -> USB_RXCSRH5_AUTORQ_W {
        USB_RXCSRH5_AUTORQ_W::new(self)
    }
    #[doc = "Bit 7 - Auto Clear"]
    #[inline(always)]
    pub fn usb_rxcsrh5_autocl(&mut self) -> USB_RXCSRH5_AUTOCL_W {
