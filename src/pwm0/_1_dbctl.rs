...
pub struct R(crate::R<_1_DBCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_1_DBCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_1_DBCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_1_DBCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `_1_DBCTL` writer"]
pub struct W(crate::W<_1_DBCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<_1_DBCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<_1_DBCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<_1_DBCTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PWM_1_DBCTL_ENABLE` reader - Dead-Band Generator Enable"]
pub type PWM_1_DBCTL_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `PWM_1_DBCTL_ENABLE` writer - Dead-Band Generator Enable"]
pub type PWM_1_DBCTL_ENABLE_W<'a> = crate::BitWriter<'a, u32, _1_DBCTL_SPEC, bool, 0>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Dead-Band Generator Enable"]
    #[inline(always)]
    pub fn pwm_1_dbctl_enable(&mut self) -> PWM_1_DBCTL_ENABLE_W {
