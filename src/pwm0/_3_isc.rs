...
pub struct R(crate::R<_3_ISC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_3_ISC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_3_ISC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_3_ISC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `_3_ISC` writer"]
pub struct W(crate::W<_3_ISC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<_3_ISC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<_3_ISC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<_3_ISC_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PWM_3_ISC_INTCNTZERO` reader - Counter=0 Interrupt"]
pub type PWM_3_ISC_INTCNTZERO_R = crate::BitReader<bool>;
#[doc = "Field `PWM_3_ISC_INTCNTZERO` writer - Counter=0 Interrupt"]
pub type PWM_3_ISC_INTCNTZERO_W<'a> = crate::BitWriter<'a, u32, _3_ISC_SPEC, bool, 0>;
#[doc = "Field `PWM_3_ISC_INTCNTLOAD` reader - Counter=Load Interrupt"]
pub type PWM_3_ISC_INTCNTLOAD_R = crate::BitReader<bool>;
#[doc = "Field `PWM_3_ISC_INTCNTLOAD` writer - Counter=Load Interrupt"]
pub type PWM_3_ISC_INTCNTLOAD_W<'a> = crate::BitWriter<'a, u32, _3_ISC_SPEC, bool, 1>;
#[doc = "Field `PWM_3_ISC_INTCMPAU` reader - Comparator A Up Interrupt"]
pub type PWM_3_ISC_INTCMPAU_R = crate::BitReader<bool>;
#[doc = "Field `PWM_3_ISC_INTCMPAU` writer - Comparator A Up Interrupt"]
pub type PWM_3_ISC_INTCMPAU_W<'a> = crate::BitWriter<'a, u32, _3_ISC_SPEC, bool, 2>;
#[doc = "Field `PWM_3_ISC_INTCMPAD` reader - Comparator A Down Interrupt"]
pub type PWM_3_ISC_INTCMPAD_R = crate::BitReader<bool>;
#[doc = "Field `PWM_3_ISC_INTCMPAD` writer - Comparator A Down Interrupt"]
pub type PWM_3_ISC_INTCMPAD_W<'a> = crate::BitWriter<'a, u32, _3_ISC_SPEC, bool, 3>;
#[doc = "Field `PWM_3_ISC_INTCMPBU` reader - Comparator B Up Interrupt"]
pub type PWM_3_ISC_INTCMPBU_R = crate::BitReader<bool>;
#[doc = "Field `PWM_3_ISC_INTCMPBU` writer - Comparator B Up Interrupt"]
pub type PWM_3_ISC_INTCMPBU_W<'a> = crate::BitWriter<'a, u32, _3_ISC_SPEC, bool, 4>;
#[doc = "Field `PWM_3_ISC_INTCMPBD` reader - Comparator B Down Interrupt"]
pub type PWM_3_ISC_INTCMPBD_R = crate::BitReader<bool>;
#[doc = "Field `PWM_3_ISC_INTCMPBD` writer - Comparator B Down Interrupt"]
pub type PWM_3_ISC_INTCMPBD_W<'a> = crate::BitWriter<'a, u32, _3_ISC_SPEC, bool, 5>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Counter=0 Interrupt"]
    #[inline(always)]
    pub fn pwm_3_isc_intcntzero(&mut self) -> PWM_3_ISC_INTCNTZERO_W {
        PWM_3_ISC_INTCNTZERO_W::new(self)
    }
    #[doc = "Bit 1 - Counter=Load Interrupt"]
    #[inline(always)]
    pub fn pwm_3_isc_intcntload(&mut self) -> PWM_3_ISC_INTCNTLOAD_W {
        PWM_3_ISC_INTCNTLOAD_W::new(self)
    }
    #[doc = "Bit 2 - Comparator A Up Interrupt"]
    #[inline(always)]
    pub fn pwm_3_isc_intcmpau(&mut self) -> PWM_3_ISC_INTCMPAU_W {
        PWM_3_ISC_INTCMPAU_W::new(self)
    }
    #[doc = "Bit 3 - Comparator A Down Interrupt"]
    #[inline(always)]
    pub fn pwm_3_isc_intcmpad(&mut self) -> PWM_3_ISC_INTCMPAD_W {
        PWM_3_ISC_INTCMPAD_W::new(self)
    }
    #[doc = "Bit 4 - Comparator B Up Interrupt"]
    #[inline(always)]
    pub fn pwm_3_isc_intcmpbu(&mut self) -> PWM_3_ISC_INTCMPBU_W {
        PWM_3_ISC_INTCMPBU_W::new(self)
    }
    #[doc = "Bit 5 - Comparator B Down Interrupt"]
    #[inline(always)]
    pub fn pwm_3_isc_intcmpbd(&mut self) -> PWM_3_ISC_INTCMPBD_W {
