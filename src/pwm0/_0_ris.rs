...
pub struct R(crate::R<_0_RIS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_0_RIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_0_RIS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_0_RIS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `_0_RIS` writer"]
pub struct W(crate::W<_0_RIS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<_0_RIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<_0_RIS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<_0_RIS_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PWM_0_RIS_INTCNTZERO` reader - Counter=0 Interrupt Status"]
pub type PWM_0_RIS_INTCNTZERO_R = crate::BitReader<bool>;
#[doc = "Field `PWM_0_RIS_INTCNTZERO` writer - Counter=0 Interrupt Status"]
pub type PWM_0_RIS_INTCNTZERO_W<'a> = crate::BitWriter<'a, u32, _0_RIS_SPEC, bool, 0>;
#[doc = "Field `PWM_0_RIS_INTCNTLOAD` reader - Counter=Load Interrupt Status"]
pub type PWM_0_RIS_INTCNTLOAD_R = crate::BitReader<bool>;
#[doc = "Field `PWM_0_RIS_INTCNTLOAD` writer - Counter=Load Interrupt Status"]
pub type PWM_0_RIS_INTCNTLOAD_W<'a> = crate::BitWriter<'a, u32, _0_RIS_SPEC, bool, 1>;
#[doc = "Field `PWM_0_RIS_INTCMPAU` reader - Comparator A Up Interrupt Status"]
pub type PWM_0_RIS_INTCMPAU_R = crate::BitReader<bool>;
#[doc = "Field `PWM_0_RIS_INTCMPAU` writer - Comparator A Up Interrupt Status"]
pub type PWM_0_RIS_INTCMPAU_W<'a> = crate::BitWriter<'a, u32, _0_RIS_SPEC, bool, 2>;
#[doc = "Field `PWM_0_RIS_INTCMPAD` reader - Comparator A Down Interrupt Status"]
pub type PWM_0_RIS_INTCMPAD_R = crate::BitReader<bool>;
#[doc = "Field `PWM_0_RIS_INTCMPAD` writer - Comparator A Down Interrupt Status"]
pub type PWM_0_RIS_INTCMPAD_W<'a> = crate::BitWriter<'a, u32, _0_RIS_SPEC, bool, 3>;
#[doc = "Field `PWM_0_RIS_INTCMPBU` reader - Comparator B Up Interrupt Status"]
pub type PWM_0_RIS_INTCMPBU_R = crate::BitReader<bool>;
#[doc = "Field `PWM_0_RIS_INTCMPBU` writer - Comparator B Up Interrupt Status"]
pub type PWM_0_RIS_INTCMPBU_W<'a> = crate::BitWriter<'a, u32, _0_RIS_SPEC, bool, 4>;
#[doc = "Field `PWM_0_RIS_INTCMPBD` reader - Comparator B Down Interrupt Status"]
pub type PWM_0_RIS_INTCMPBD_R = crate::BitReader<bool>;
#[doc = "Field `PWM_0_RIS_INTCMPBD` writer - Comparator B Down Interrupt Status"]
pub type PWM_0_RIS_INTCMPBD_W<'a> = crate::BitWriter<'a, u32, _0_RIS_SPEC, bool, 5>;
impl R {
...
impl W {
    #[doc = "Bit 0 - Counter=0 Interrupt Status"]
    #[inline(always)]
    pub fn pwm_0_ris_intcntzero(&mut self) -> PWM_0_RIS_INTCNTZERO_W {
        PWM_0_RIS_INTCNTZERO_W::new(self)
    }
    #[doc = "Bit 1 - Counter=Load Interrupt Status"]
    #[inline(always)]
    pub fn pwm_0_ris_intcntload(&mut self) -> PWM_0_RIS_INTCNTLOAD_W {
        PWM_0_RIS_INTCNTLOAD_W::new(self)
    }
    #[doc = "Bit 2 - Comparator A Up Interrupt Status"]
    #[inline(always)]
    pub fn pwm_0_ris_intcmpau(&mut self) -> PWM_0_RIS_INTCMPAU_W {
        PWM_0_RIS_INTCMPAU_W::new(self)
    }
    #[doc = "Bit 3 - Comparator A Down Interrupt Status"]
    #[inline(always)]
    pub fn pwm_0_ris_intcmpad(&mut self) -> PWM_0_RIS_INTCMPAD_W {
        PWM_0_RIS_INTCMPAD_W::new(self)
    }
    #[doc = "Bit 4 - Comparator B Up Interrupt Status"]
    #[inline(always)]
    pub fn pwm_0_ris_intcmpbu(&mut self) -> PWM_0_RIS_INTCMPBU_W {
        PWM_0_RIS_INTCMPBU_W::new(self)
    }
    #[doc = "Bit 5 - Comparator B Down Interrupt Status"]
    #[inline(always)]
    pub fn pwm_0_ris_intcmpbd(&mut self) -> PWM_0_RIS_INTCMPBD_W {
