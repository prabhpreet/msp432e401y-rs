...
pub struct R(crate::R<_2_DBFALL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<_2_DBFALL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<_2_DBFALL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<_2_DBFALL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `_2_DBFALL` writer"]
pub struct W(crate::W<_2_DBFALL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<_2_DBFALL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<_2_DBFALL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<_2_DBFALL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PWM_2_DBFALL_FALLDELAY` reader - Dead-Band Fall Delay"]
pub type PWM_2_DBFALL_FALLDELAY_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PWM_2_DBFALL_FALLDELAY` writer - Dead-Band Fall Delay"]
pub type PWM_2_DBFALL_FALLDELAY_W<'a> =
    crate::FieldWriter<'a, u32, _2_DBFALL_SPEC, u16, u16, 12, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:11 - Dead-Band Fall Delay"]
    #[inline(always)]
    pub fn pwm_2_dbfall_falldelay(&mut self) -> PWM_2_DBFALL_FALLDELAY_W {
