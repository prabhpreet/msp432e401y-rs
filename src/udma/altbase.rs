...
pub struct W(crate::W<ALTBASE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ALTBASE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ALTBASE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ALTBASE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `UDMA_ALTBASE_ADDR` reader - Alternate Channel Address Pointer"]
pub type UDMA_ALTBASE_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `UDMA_ALTBASE_ADDR` writer - Alternate Channel Address Pointer"]
pub type UDMA_ALTBASE_ADDR_W<'a> = crate::FieldWriter<'a, u32, ALTBASE_SPEC, u32, u32, 32, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Alternate Channel Address Pointer"]
    #[inline(always)]
    pub fn udma_altbase_addr(&mut self) -> UDMA_ALTBASE_ADDR_W {
