...
pub struct R(crate::R<FMPPE3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FMPPE3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FMPPE3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FMPPE3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FMPPE3` writer"]
pub struct W(crate::W<FMPPE3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FMPPE3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FMPPE3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FMPPE3_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
