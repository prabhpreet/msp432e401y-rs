...
pub struct R(crate::R<FMPPE2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FMPPE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FMPPE2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FMPPE2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FMPPE2` writer"]
pub struct W(crate::W<FMPPE2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FMPPE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FMPPE2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FMPPE2_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
