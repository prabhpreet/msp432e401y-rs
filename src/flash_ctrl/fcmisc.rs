...
pub struct R(crate::R<FCMISC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FCMISC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FCMISC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FCMISC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FCMISC` writer"]
pub struct W(crate::W<FCMISC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FCMISC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    ...
    #[doc = "Bit 2 - EEPROM Masked Interrupt Status and Clear"]
    #[inline(always)]
    pub fn flash_fcmisc_emisc(&mut self) -> FLASH_FCMISC_EMISC_W {
        FLASH_FCMISC_EMISC_W::new(self)
    }
    #[doc = "Bit 9 - VOLT Masked Interrupt Status and Clear"]
    #[inline(always)]
    pub fn flash_fcmisc_voltmisc(&mut self) -> FLASH_FCMISC_VOLTMISC_W {
        FLASH_FCMISC_VOLTMISC_W::new(self)
    }
    #[doc = "Bit 10 - Invalid Data Masked Interrupt Status and Clear"]
    #[inline(always)]
    pub fn flash_fcmisc_invdmisc(&mut self) -> FLASH_FCMISC_INVDMISC_W {
        FLASH_FCMISC_INVDMISC_W::new(self)
    }
    #[doc = "Bit 11 - ERVER Masked Interrupt Status and Clear"]
    #[inline(always)]
    pub fn flash_fcmisc_ermisc(&mut self) -> FLASH_FCMISC_ERMISC_W {
        FLASH_FCMISC_ERMISC_W::new(self)
    }
    #[doc = "Bit 13 - PROGVER Masked Interrupt Status and Clear"]
    #[inline(always)]
    pub fn flash_fcmisc_progmisc(&mut self) -> FLASH_FCMISC_PROGMISC_W {
