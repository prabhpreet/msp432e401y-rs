...
#[doc = "Field `SHAMD5_REVISION` reader - Revision Number"]
pub type SHAMD5_REVISION_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SHAMD5_REVISION` writer - Revision Number"]
pub type SHAMD5_REVISION_W<'a> = crate::FieldWriter<'a, u32, REVISION_SPEC, u32, u32, 32, 0>;
impl R {
    #[doc = "Bits 0:31 - Revision Number"]
    #[inline(always)]
    pub fn shamd5_revision(&self) -> SHAMD5_REVISION_R {
        SHAMD5_REVISION_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Revision Number"]
    #[inline(always)]
    pub fn shamd5_revision(&mut self) -> SHAMD5_REVISION_W {
        SHAMD5_REVISION_W::new(self)
    }
