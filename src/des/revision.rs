...
#[doc = "Field `DES_REVISION` reader - Revision number"]
pub type DES_REVISION_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DES_REVISION` writer - Revision number"]
pub type DES_REVISION_W<'a> = crate::FieldWriter<'a, u32, REVISION_SPEC, u32, u32, 32, 0>;
impl R {
    #[doc = "Bits 0:31 - Revision number"]
    #[inline(always)]
    pub fn des_revision(&self) -> DES_REVISION_R {
        DES_REVISION_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Revision number"]
    #[inline(always)]
    pub fn des_revision(&mut self) -> DES_REVISION_W {
        DES_REVISION_W::new(self)
    }
